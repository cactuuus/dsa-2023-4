...
AVL Tree Priority Queues Solution
"""
...
class AVLTreePriorityQueue(Base[Priority, Item]):
    ...
    def front(self) -> tuple[Priority, Item]:
        ...
        """
        priority = self._get_highest_priority()
    ...
    def _get_highest_priority(self) -> Priority:
        if self._is_max:
            return self._items.get_maximum_key()
        else:
            return self._items.get_minimum_key()
